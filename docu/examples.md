...
For more info regarding automatically column names recognition of the GWAS file, see section `GWAS dataset` in the [manual](https://github.com/zkutalik/ssimp_software/blob/master/docu/manual.md).
...
For detailed instructions and explanations see detailed instructions in [usage-text](https://github.com/zkutalik/ssimp_software/blob/master/docu/usage.txt).
...
[//]: -------------------------------
Follow the instructions in [docu/usage](https://github.com/zkutalik/ssimp_software/blob/master/docu/usage.txt).
