...
While the github folder itself is rather small (136 MB), the folder `reference_panels` that you download partially yourself is around 17 GB large when 1KG is installed.
