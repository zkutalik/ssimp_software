...
More info on handling reference panel data can be found starting from line 49 in [usage message](https://github.com/zkutalik/ssimp_software/blob/master/doc/usage.txt).
